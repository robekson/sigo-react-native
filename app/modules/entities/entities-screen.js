  ...
  render() {
    return (
      <ScrollView style={styles.container} testID="entityScreenScrollList">
        ...
        <RoundedButton text="Venda" onPress={vendaEntityScreen} testID="vendaEntityScreenButton" />
        <RoundedButton text="Funcionario" onPress={funcionarioEntityScreen} testID="funcionarioEntityScreenButton" />

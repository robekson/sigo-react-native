...
import { VendaTypes } from '../../modules/entities/venda/venda.reducer'
import { FuncionarioTypes } from '../../modules/entities/funcionario/funcionario.reducer'
...
import { getVenda, getVendas, updateVenda, deleteVenda, searchVendas } from '../../modules/entities/venda/venda.sagas'
import {
  getFuncionario,
  getFuncionarios,
  updateFuncionario,
  deleteFuncionario,
  searchFuncionarios,
} from '../../modules/entities/funcionario/funcionario.sagas'
...
export default function* root() {
  yield all([
    ...
    takeLatest(VendaTypes.VENDA_REQUEST, getVenda, api),
    takeLatest(VendaTypes.VENDA_ALL_REQUEST, getVendas, api),
    takeLatest(VendaTypes.VENDA_UPDATE_REQUEST, updateVenda, api),
    takeLatest(VendaTypes.VENDA_DELETE_REQUEST, deleteVenda, api),
    takeLatest(VendaTypes.VENDA_SEARCH_REQUEST, searchVendas, api),

    takeLatest(FuncionarioTypes.FUNCIONARIO_REQUEST, getFuncionario, api),
    takeLatest(FuncionarioTypes.FUNCIONARIO_ALL_REQUEST, getFuncionarios, api),
    takeLatest(FuncionarioTypes.FUNCIONARIO_UPDATE_REQUEST, updateFuncionario, api),
    takeLatest(FuncionarioTypes.FUNCIONARIO_DELETE_REQUEST, deleteFuncionario, api),
    takeLatest(FuncionarioTypes.FUNCIONARIO_SEARCH_REQUEST, searchFuncionarios, api),
